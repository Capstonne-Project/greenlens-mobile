---
name: screen
description: Scaffold màn hình React Native hoàn chỉnh cho GreenLens với dual-system UI (gluestack-ui v4 hoặc react-native-reusables). Dùng khi tạo screen mới trong app/ và cần tạo luôn component + hook đúng kiến trúc.
...
## Bước 2 — Chọn UI system cho components của screen

- Chọn `gluestack-ui v4` cho primitives/compound chuẩn: Button, Input, Form, Modal, Select, Avatar, Badge.
- Chọn `react-native-reusables` cho component app-specific: ReportCard, EmptyState biến thể custom, FilterBar, section blocks.
- Ghi rõ lựa chọn cho từng component chính trước khi tạo file.

## Bước 3 — Tạo hook data (nếu cần fetch)
...
## Bước 5 — Loading & Empty state (bắt buộc với list screen)
...
## Bước 6 — Form screen (auth / create report)
...
- [ ] Mỗi component chính có UI system rõ ràng: gluestack hoặc reusables
