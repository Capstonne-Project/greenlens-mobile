...
5. Save to `.Codex/skills/learned/{pattern-name}.md`
...
description: >
  ...
  Be specific enough that Codex will recognize the situation.}
type: learned
...
Save to `.Codex/skills/learned/{pattern-name}/SKILL.md` so the skills index picks it up.
