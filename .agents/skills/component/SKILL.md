---
name: component
description: Scaffold React Native UI component mới cho GreenLens theo mô hình dual-system UI: gluestack-ui v4 hoặc react-native-reusables. Dùng khi tạo component trong src/components/, cần chọn đúng hệ UI theo ngữ cảnh và tuân thủ design system + Reanimated.
...
## Bước 2 — Chọn hệ UI (bắt buộc)

- Chọn `gluestack-ui v4` khi component cần primitive/compound chuẩn (Button, Input, Form, Modal, Select, Avatar, Badge) hoặc cần variants rõ ràng.
- Chọn `react-native-reusables` khi component app-specific, cần copy-custom nhanh bằng NativeWind (ví dụ: ReportCard, EmptyState, FilterBar, custom list item).
- Không trộn 2 hệ trong cùng một component nếu không có lý do rõ ràng.

## Bước 3 — Tạo file component
...
## Bước 4 — Checklist trước khi xong
...
- [ ] Ghi rõ UI system đã dùng: `gluestack-ui v4` hoặc `react-native-reusables`

## Bước 5 — Nếu component có loading state
...
## Bước 6 — Performance Pattern (List Item)
...
- UI system đã chọn + lý do ngắn
- tên file, export name
- props interface tóm tắt
